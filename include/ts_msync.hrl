...
-define(msync_appkey,     "ltorg0#openapp0" ). %% added for msync
-define(msync_username,     "tsunguser" ).
-define(msync_passwd,     "sesame").
-define(msync_domain,       "erlang-projects.org").
-define(msync_userid_max,   10000 ).
-define(msync_global_number,100).
